...
<div id="stateToggle" class="row">
	<span onclick="CIC.mapToggle('map')" id="state-toggle-map">Map View</span><span onclick="CIC.mapToggle('table')" id="state-toggle-table">Table View</span>
</div>
